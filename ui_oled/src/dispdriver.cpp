...
void DispDriver::command(unsigned char cmd){
    digitalWrite(DC,LOW);
    wiringPiSPIDataRW(channel,&cmd,1);
}

void DispDriver::SSD1306_begin()
{
    pinMode(RST,OUTPUT);
    pinMode(DC,OUTPUT);
...
void DispDriver::SSD1306_pixel(int x,int y,char color)
{
...
void DispDriver::SSD1306_char1616(unsigned char x,unsigned char y,unsigned char chChar)
{
        unsigned char i, j;
...
void DispDriver::SSD1306_char3216(unsigned char x,unsigned char y,unsigned char chChar)
{
        unsigned char i, j;
        unsigned char chTemp = 0, y0 = y, chMode = 0;
...
void DispDriver::SSD1306_char(unsigned char x,unsigned char y,char acsii,char size,char mode)
{
...
void DispDriver::SSD1306_string(unsigned char x,unsigned char y, const char *pString,
...
void DispDriver::SSD1306_bitmap(unsigned char x,unsigned char y,const unsigned char *pBmp,
...
void DispDriver::SSD1306_display()
{
